...
func NewUUID(bindingUUID binding.GolemApi1_1_0_HostUuid) uuid.UUID {
	var bs [16]byte
...
func UUIDToBinding(goUUID uuid.UUID) binding.GolemApi1_1_0_HostUuid {
	return binding.GolemApi1_1_0_HostUuid{
