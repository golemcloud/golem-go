...
// Package blobstore represents the imported interface "wasi:blobstore/blobstore".
//
// wasi-cloud Blobstore service definition
package blobstore

import (
	"github.com/golemcloud/golem-go/binding/wasi/blobstore/container"
	"github.com/golemcloud/golem-go/binding/wasi/blobstore/types"
	"go.bytecodealliance.org/cm"
)

// Container represents the imported type alias "wasi:blobstore/blobstore#container".
//
// See [container.Container] for more information.
type Container = container.Container

// Error represents the type alias "wasi:blobstore/blobstore#error".
//
// See [types.Error] for more information.
type Error = types.Error

// ContainerName represents the type alias "wasi:blobstore/blobstore#container-name".
//
// See [types.ContainerName] for more information.
type ContainerName = types.ContainerName

// ObjectID represents the type alias "wasi:blobstore/blobstore#object-id".
//
