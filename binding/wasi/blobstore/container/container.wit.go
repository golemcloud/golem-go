...
// Package container represents the imported interface "wasi:blobstore/container".
//
...
// InputStream represents the imported type alias "wasi:blobstore/container#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:blobstore/container#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// ContainerMetadata represents the type alias "wasi:blobstore/container#container-metadata".
//
// See [types.ContainerMetadata] for more information.
type ContainerMetadata = types.ContainerMetadata

// Error represents the type alias "wasi:blobstore/container#error".
//
// See [types.Error] for more information.
type Error = types.Error

// IncomingValue represents the imported type alias "wasi:blobstore/container#incoming-value".
//
// See [types.IncomingValue] for more information.
type IncomingValue = types.IncomingValue

// ObjectMetadata represents the type alias "wasi:blobstore/container#object-metadata".
//
// See [types.ObjectMetadata] for more information.
type ObjectMetadata = types.ObjectMetadata

// ObjectName represents the type alias "wasi:blobstore/container#object-name".
//
// See [types.ObjectName] for more information.
type ObjectName = types.ObjectName

// OutgoingValue represents the imported type alias "wasi:blobstore/container#outgoing-value".
//
// See [types.OutgoingValue] for more information.
type OutgoingValue = types.OutgoingValue

// Container represents the imported resource "wasi:blobstore/container#container".
//
...
// StreamObjectNames represents the imported resource "wasi:blobstore/container#stream-object-names".
//
