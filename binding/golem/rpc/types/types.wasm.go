...
// This file contains wasmimport and wasmexport declarations for "golem:rpc@0.2.0".

//go:wasmimport golem:rpc/types@0.2.0 [resource-drop]wasm-rpc
//go:noescape
func wasmimport_WasmRPCResourceDrop(self0 uint32)

//go:wasmimport golem:rpc/types@0.2.0 [constructor]wasm-rpc
//go:noescape
func wasmimport_NewWasmRPC(workerId0 uint64, workerId1 uint64, workerId2 *uint8, workerId3 uint32) (result0 uint32)

//go:wasmimport golem:rpc/types@0.2.0 [static]wasm-rpc.ephemeral
//go:noescape
func wasmimport_WasmRPCEphemeral(componentId0 uint64, componentId1 uint64) (result0 uint32)

//go:wasmimport golem:rpc/types@0.2.0 [method]wasm-rpc.async-invoke-and-await
//go:noescape
...
//go:wasmimport golem:rpc/types@0.2.0 [method]wasm-rpc.invoke
//go:noescape
...
//go:wasmimport golem:rpc/types@0.2.0 [method]wasm-rpc.invoke-and-await
//go:noescape
...
//go:wasmimport golem:rpc/types@0.2.0 [method]wasm-rpc.schedule-cancelable-invocation
//go:noescape
...
//go:wasmimport golem:rpc/types@0.2.0 [method]wasm-rpc.schedule-invocation
//go:noescape
