...
// Package oplog represents the imported interface "golem:api/oplog@1.1.6".
//
...
// DateTime represents the type alias "golem:api/oplog@1.1.6#datetime".
//
// See [wallclock.DateTime] for more information.
type DateTime = wallclock.DateTime

// WitValue represents the type alias "golem:api/oplog@1.1.6#wit-value".
//
// See [types.WitValue] for more information.
type WitValue = types.WitValue

// AccountID represents the type alias "golem:api/oplog@1.1.6#account-id".
//
// See [host.AccountID] for more information.
type AccountID = host.AccountID

// ComponentVersion represents the type alias "golem:api/oplog@1.1.6#component-version".
//
// See [host.ComponentVersion] for more information.
type ComponentVersion = host.ComponentVersion

// OplogIndex represents the type alias "golem:api/oplog@1.1.6#oplog-index".
//
...
// UUID represents the type alias "golem:api/oplog@1.1.6#uuid".
//
// See [host.UUID] for more information.
type UUID = host.UUID

// WorkerID represents the type alias "golem:api/oplog@1.1.6#worker-id".
//
// See [host.WorkerID] for more information.
type WorkerID = host.WorkerID

// Attribute represents the type alias "golem:api/oplog@1.1.6#attribute".
//
// See [context.Attribute] for more information.
type Attribute = context.Attribute

// AttributeValue represents the type alias "golem:api/oplog@1.1.6#attribute-value".
//
// See [context.AttributeValue] for more information.
type AttributeValue = context.AttributeValue

// SpanID represents the type alias "golem:api/oplog@1.1.6#span-id".
//
// See [context.SpanID] for more information.
type SpanID = context.SpanID

// TraceID represents the type alias "golem:api/oplog@1.1.6#trace-id".
//
// See [context.TraceID] for more information.
type TraceID = context.TraceID

// WrappedFunctionType represents the variant "golem:api/oplog@1.1.6#wrapped-function-type".
//
...
// PluginInstallationDescription represents the record "golem:api/oplog@1.1.6#plugin-installation-description".
//
...
// CreateParameters represents the record "golem:api/oplog@1.1.6#create-parameters".
//
...
// ImportedFunctionInvokedParameters represents the record "golem:api/oplog@1.1.6#imported-function-invoked-parameters".
//
...
// LocalSpanData represents the record "golem:api/oplog@1.1.6#local-span-data".
//
...
// ExternalSpanData represents the record "golem:api/oplog@1.1.6#external-span-data".
//
...
// SpanData represents the variant "golem:api/oplog@1.1.6#span-data".
//
//	variant span-data {
...
// ExportedFunctionInvokedParameters represents the record "golem:api/oplog@1.1.6#exported-function-invoked-parameters".
//
...
// ExportedFunctionCompletedParameters represents the record "golem:api/oplog@1.1.6#exported-function-completed-parameters".
//
...
// ErrorParameters represents the record "golem:api/oplog@1.1.6#error-parameters".
//
...
// JumpParameters represents the record "golem:api/oplog@1.1.6#jump-parameters".
//
...
// ChangeRetryPolicyParameters represents the record "golem:api/oplog@1.1.6#change-retry-policy-parameters".
//
...
// EndAtomicRegionParameters represents the record "golem:api/oplog@1.1.6#end-atomic-region-parameters".
//
...
// EndRemoteWriteParameters represents the record "golem:api/oplog@1.1.6#end-remote-write-parameters".
//
...
// ExportedFunctionInvocationParameters represents the record "golem:api/oplog@1.1.6#exported-function-invocation-parameters".
//
...
// WorkerInvocation represents the variant "golem:api/oplog@1.1.6#worker-invocation".
//
...
// PendingWorkerInvocationParameters represents the record "golem:api/oplog@1.1.6#pending-worker-invocation-parameters".
//
...
// UpdateDescription represents the variant "golem:api/oplog@1.1.6#update-description".
//
...
// PendingUpdateParameters represents the record "golem:api/oplog@1.1.6#pending-update-parameters".
//
...
// SuccessfulUpdateParameters represents the record "golem:api/oplog@1.1.6#successful-update-parameters".
//
...
// FailedUpdateParameters represents the record "golem:api/oplog@1.1.6#failed-update-parameters".
//
...
// GrowMemoryParameters represents the record "golem:api/oplog@1.1.6#grow-memory-parameters".
//
...
// WorkerResourceID represents the u64 "golem:api/oplog@1.1.6#worker-resource-id".
//
//	type worker-resource-id = u64
type WorkerResourceID uint64

// CreateResourceParameters represents the record "golem:api/oplog@1.1.6#create-resource-parameters".
//
...
// DropResourceParameters represents the record "golem:api/oplog@1.1.6#drop-resource-parameters".
//
...
// DescribeResourceParameters represents the record "golem:api/oplog@1.1.6#describe-resource-parameters".
//
...
// LogLevel represents the enum "golem:api/oplog@1.1.6#log-level".
//
//	enum log-level {
//		stdout,
//		stderr,
...
// LogParameters represents the record "golem:api/oplog@1.1.6#log-parameters".
//
...
// ActivatePluginParameters represents the record "golem:api/oplog@1.1.6#activate-plugin-parameters".
//
...
// DeactivatePluginParameters represents the record "golem:api/oplog@1.1.6#deactivate-plugin-parameters".
//
...
// RevertParameters represents the record "golem:api/oplog@1.1.6#revert-parameters".
//
...
// CancelInvocationParameters represents the record "golem:api/oplog@1.1.6#cancel-invocation-parameters".
//
...
// StartSpanParameters represents the record "golem:api/oplog@1.1.6#start-span-parameters".
//
...
// FinishSpanParameters represents the record "golem:api/oplog@1.1.6#finish-span-parameters".
//
...
// SetSpanAttributeParameters represents the record "golem:api/oplog@1.1.6#set-span-attribute-parameters".
//
...
// GetOplog represents the imported resource "golem:api/oplog@1.1.6#get-oplog".
//
//	resource get-oplog
...
// SearchOplog represents the imported resource "golem:api/oplog@1.1.6#search-oplog".
//
