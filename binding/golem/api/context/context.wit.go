...
// Package context represents the imported interface "golem:api/context@1.1.7".
//
...
// DateTime represents the type alias "golem:api/context@1.1.7#datetime".
//
// See [wallclock.DateTime] for more information.
type DateTime = wallclock.DateTime

// Span represents the imported resource "golem:api/context@1.1.7#span".
//
...
// InvocationContext represents the imported resource "golem:api/context@1.1.7#invocation-context".
//
...
// AttributeValue represents the variant "golem:api/context@1.1.7#attribute-value".
//
...
// Attribute represents the record "golem:api/context@1.1.7#attribute".
//
...
// AttributeChain represents the record "golem:api/context@1.1.7#attribute-chain".
//
...
// TraceID represents the string "golem:api/context@1.1.7#trace-id".
//
...
// SpanID represents the string "golem:api/context@1.1.7#span-id".
//
