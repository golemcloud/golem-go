...
func WasiPollPollPollOneoff(in []uint32) []uint8 {
  var lower_in C.go_wasi_http_list_pollable_t
  if len(in) == 0 {
    lower_in.ptr = nil
    lower_in.len = 0
  } else {
  ...
  defer C.go_wasi_http_list_pollable_free(&lower_in)
  var ret C.go_wasi_http_list_u8_t
...
func WasiIoStreamsRead(this uint32, len uint64) Result[WasiIoStreamsTuple2ListU8TBoolT, WasiIoStreamsStreamError] {
  ...
  var ret C.go_wasi_http_result_tuple2_list_u8_bool_stream_error_t
  ...
  if ret.is_err {
    ...
    lift_ret_ptr := *(*C.go_wasi_http_tuple2_list_u8_bool_t)(unsafe.Pointer(&ret.val))
...
func WasiIoStreamsSkip(this uint32, len uint64) Result[WasiIoStreamsTuple2U64BoolT, WasiIoStreamsStreamError] {
  ...
  lower_this = lower_this_val
  lower_len := C.uint64_t(len)
  var ret C.go_wasi_http_result_tuple2_u64_bool_stream_error_t
  ...
  if ret.is_err {
    ...
    lift_ret_ptr := *(*C.go_wasi_http_tuple2_u64_bool_t)(unsafe.Pointer(&ret.val))
...
func WasiIoStreamsWrite(this uint32, buf []uint8) Result[uint64, WasiIoStreamsStreamError] {
  ...
  lower_this_val := C.uint32_t(this)
  lower_this = lower_this_val
  var lower_buf C.go_wasi_http_list_u8_t
  if len(buf) == 0 {
    lower_buf.ptr = nil
    lower_buf.len = 0
  } else {
  ...
  defer C.go_wasi_http_list_u8_free(&lower_buf)
  var ret C.go_wasi_http_result_u64_stream_error_t
...
func WasiHttpTypesNewFields(entries []WasiHttpTypesTuple2StringStringT) uint32 {
  var lower_entries C.go_wasi_http_list_tuple2_string_string_t
  if len(entries) == 0 {
    lower_entries.ptr = nil
    lower_entries.len = 0
  } else {
    var empty_lower_entries C.go_wasi_http_tuple2_string_string_t
    lower_entries.ptr = (*C.go_wasi_http_tuple2_string_string_t)(C.malloc(C.size_t(len(entries)) * C.size_t(unsafe.Sizeof(empty_lower_entries))))
    lower_entries.len = C.size_t(len(entries))
    for lower_entries_i := range entries {
      lower_entries_ptr := (*C.go_wasi_http_tuple2_string_string_t)(unsafe.Pointer(uintptr(unsafe.Pointer(lower_entries.ptr)) +
      uintptr(lower_entries_i)*unsafe.Sizeof(empty_lower_entries)))
      var lower_entries_ptr_value C.go_wasi_http_tuple2_string_string_t
      var lower_entries_ptr_value_f0 C.go_wasi_http_string_t
      ...
      var lower_entries_ptr_value_f1 C.go_wasi_http_string_t
  ...
  defer C.go_wasi_http_list_tuple2_string_string_free(&lower_entries)
...
func WasiHttpTypesFieldsGet(fields uint32, name string) []string {
  var lower_fields C.uint32_t
  lower_fields_val := C.uint32_t(fields)
  lower_fields = lower_fields_val
  var lower_name C.go_wasi_http_string_t
  
  lower_name.ptr = C.CString(name)
  lower_name.len = C.size_t(len(name))
  defer C.go_wasi_http_string_free(&lower_name)
  var ret C.go_wasi_http_list_string_t
  C.wasi_http_types_fields_get(lower_fields, &lower_name, &ret)
  var lift_ret []string
  lift_ret = make([]string, ret.len)
  if ret.len > 0 {
    for lift_ret_i := 0; lift_ret_i < int(ret.len); lift_ret_i++ {
      var empty_lift_ret C.go_wasi_http_string_t
      lift_ret_ptr := *(*C.go_wasi_http_string_t)(unsafe.Pointer(uintptr(unsafe.Pointer(ret.ptr)) +
      uintptr(lift_ret_i)*unsafe.Sizeof(empty_lift_ret)))
...
func WasiHttpTypesFieldsSet(fields uint32, name string, value []string) {
  var lower_fields C.uint32_t
  lower_fields_val := C.uint32_t(fields)
  lower_fields = lower_fields_val
  var lower_name C.go_wasi_http_string_t
  ...
  lower_name.len = C.size_t(len(name))
  defer C.go_wasi_http_string_free(&lower_name)
  var lower_value C.go_wasi_http_list_string_t
  if len(value) == 0 {
    lower_value.ptr = nil
    lower_value.len = 0
  } else {
    var empty_lower_value C.go_wasi_http_string_t
    lower_value.ptr = (*C.go_wasi_http_string_t)(C.malloc(C.size_t(len(value)) * C.size_t(unsafe.Sizeof(empty_lower_value))))
    lower_value.len = C.size_t(len(value))
    for lower_value_i := range value {
      lower_value_ptr := (*C.go_wasi_http_string_t)(unsafe.Pointer(uintptr(unsafe.Pointer(lower_value.ptr)) +
      uintptr(lower_value_i)*unsafe.Sizeof(empty_lower_value)))
      var lower_value_ptr_value C.go_wasi_http_string_t
  ...
  defer C.go_wasi_http_list_string_free(&lower_value)
...
func WasiHttpTypesFieldsAppend(fields uint32, name string, value string) {
  var lower_fields C.uint32_t
  lower_fields_val := C.uint32_t(fields)
  lower_fields = lower_fields_val
  var lower_name C.go_wasi_http_string_t
  ...
  lower_name.len = C.size_t(len(name))
  defer C.go_wasi_http_string_free(&lower_name)
  var lower_value C.go_wasi_http_string_t
  
  lower_value.ptr = C.CString(value)
  lower_value.len = C.size_t(len(value))
  defer C.go_wasi_http_string_free(&lower_value)
  C.wasi_http_types_fields_append(lower_fields, &lower_name, &lower_value)
}

func WasiHttpTypesFieldsEntries(fields uint32) []WasiHttpTypesTuple2StringStringT {
  var lower_fields C.uint32_t
  lower_fields_val := C.uint32_t(fields)
  lower_fields = lower_fields_val
  var ret C.go_wasi_http_list_tuple2_string_string_t
  C.wasi_http_types_fields_entries(lower_fields, &ret)
  var lift_ret []WasiHttpTypesTuple2StringStringT
  lift_ret = make([]WasiHttpTypesTuple2StringStringT, ret.len)
  if ret.len > 0 {
    for lift_ret_i := 0; lift_ret_i < int(ret.len); lift_ret_i++ {
      var empty_lift_ret C.go_wasi_http_tuple2_string_string_t
      lift_ret_ptr := *(*C.go_wasi_http_tuple2_string_string_t)(unsafe.Pointer(uintptr(unsafe.Pointer(ret.ptr)) +
      uintptr(lift_ret_i)*unsafe.Sizeof(empty_lift_ret)))
      var list_lift_ret WasiHttpTypesTuple2StringStringT
...
func WasiHttpTypesFinishIncomingStream(s uint32) Option[uint32] {
  ...
  lower_s = lower_s_val
  var ret C.go_wasi_http_option_trailers_t
...
func WasiHttpTypesFinishOutgoingStream(s uint32, trailers Option[uint32]) {
  ...
  lower_s_val = lower_s_val_val
  lower_s = lower_s_val
  var lower_trailers C.go_wasi_http_option_trailers_t
  if trailers.IsSome() {
...
func WasiHttpTypesIncomingRequestMethod(request uint32) WasiHttpTypesMethod {
  ...
  if ret.tag == 9 {
    lift_ret_ptr := *(*C.go_wasi_http_string_t)(unsafe.Pointer(&ret.val))
...
func WasiHttpTypesIncomingRequestPath(request uint32) string {
  var lower_request C.uint32_t
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.go_wasi_http_string_t
  C.wasi_http_types_incoming_request_path(lower_request, &ret)
  var lift_ret string
  lift_ret = C.GoStringN(ret.ptr, C.int(ret.len))
  return lift_ret
}

func WasiHttpTypesIncomingRequestQuery(request uint32) string {
  var lower_request C.uint32_t
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.go_wasi_http_string_t
  C.wasi_http_types_incoming_request_query(lower_request, &ret)
  var lift_ret string
  lift_ret = C.GoStringN(ret.ptr, C.int(ret.len))
  return lift_ret
}
...
func WasiHttpTypesIncomingRequestScheme(request uint32) Option[WasiHttpTypesScheme] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.go_wasi_http_option_scheme_t
  ...
  if ret.is_some {
    ...
    if ret.val.tag == 2 {
      lift_ret_val_ptr := *(*C.go_wasi_http_string_t)(unsafe.Pointer(&ret.val.val))
...
func WasiHttpTypesIncomingRequestAuthority(request uint32) string {
  var lower_request C.uint32_t
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.go_wasi_http_string_t
...
func WasiHttpTypesIncomingRequestConsume(request uint32) Result[uint32, struct{}] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.go_wasi_http_result_incoming_stream_void_t
...
func WasiHttpTypesNewOutgoingRequest(method WasiHttpTypesMethod, path string, query string, scheme Option[WasiHttpTypesScheme], authority string, headers uint32) uint32 {
  ...
  if method.Kind() == WasiHttpTypesMethodKindOther {
    ...
    lower_method.tag = 9
    lower_method_ptr := (*C.go_wasi_http_string_t)(unsafe.Pointer(&lower_method.val))
    var lower_method_val C.go_wasi_http_string_t
  ...
  var lower_path C.go_wasi_http_string_t
  
  lower_path.ptr = C.CString(path)
  lower_path.len = C.size_t(len(path))
  defer C.go_wasi_http_string_free(&lower_path)
  var lower_query C.go_wasi_http_string_t
  
  lower_query.ptr = C.CString(query)
  lower_query.len = C.size_t(len(query))
  defer C.go_wasi_http_string_free(&lower_query)
  var lower_scheme C.go_wasi_http_option_scheme_t
  if scheme.IsSome() {
    ...
    if scheme.Unwrap().Kind() == WasiHttpTypesSchemeKindOther {
      ...
      lower_scheme_val_ptr := (*C.go_wasi_http_string_t)(unsafe.Pointer(&lower_scheme_val.val))
      var lower_scheme_val_val C.go_wasi_http_string_t
  ...
  defer C.go_wasi_http_option_scheme_free(&lower_scheme)
  var lower_authority C.go_wasi_http_string_t
  
  lower_authority.ptr = C.CString(authority)
  lower_authority.len = C.size_t(len(authority))
  defer C.go_wasi_http_string_free(&lower_authority)
  ...
  ret := C.wasi_http_types_new_outgoing_request(&lower_method, &lower_path, &lower_query, &lower_scheme, &lower_authority, lower_headers)
  var lift_ret uint32
  var lift_ret_val uint32
  lift_ret_val = uint32(ret)
  lift_ret = lift_ret_val
...
func WasiHttpTypesOutgoingRequestWrite(request uint32) Result[uint32, struct{}] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.go_wasi_http_result_outgoing_stream_void_t
...
func WasiHttpTypesSetResponseOutparam(response Result[uint32, WasiHttpTypesError]) Result[struct{}, struct{}] {
  var lower_response C.go_wasi_http_result_outgoing_response_error_t
  ...
  if response.IsOk() {
    ...
    *lower_response_ptr = lower_response_val
    ...
    if response.UnwrapErr().Kind() == WasiHttpTypesErrorKindInvalidUrl {
      ...
      lower_response_val_ptr := (*C.go_wasi_http_string_t)(unsafe.Pointer(&lower_response_val.val))
      var lower_response_val_val C.go_wasi_http_string_t
  ...
  defer C.go_wasi_http_result_outgoing_response_error_free(&lower_response)
  var ret C.go_wasi_http_result_void_void_t
  C.wasi_http_types_set_response_outparam(&lower_response, &ret)
...
func WasiHttpTypesFutureIncomingResponseGet(f uint32) Option[Result[uint32, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.go_wasi_http_option_result_incoming_response_error_t
  ...
  if ret.is_some {
    ...
    if ret.val.is_err {
      ...
      if lift_ret_val_ptr.tag == 0 {
        lift_ret_val_val_ptr := *(*C.go_wasi_http_string_t)(unsafe.Pointer(&lift_ret_val_ptr.val))
...
func WasiHttpOutgoingHandlerHandle(request uint32, options Option[WasiHttpTypesRequestOptions]) uint32 {
  ...
  lower_request = lower_request_val
  var lower_options C.go_wasi_http_option_request_options_t
  if options.IsSome() {
    var lower_options_val C.wasi_http_types_request_options_t
    var lower_options_val_val C.wasi_http_types_request_options_t
    var lower_options_val_val_connect_timeout_ms C.go_wasi_http_option_u32_t
    ...
    var lower_options_val_val_first_byte_timeout_ms C.go_wasi_http_option_u32_t
    ...
    var lower_options_val_val_between_bytes_timeout_ms C.go_wasi_http_option_u32_t
