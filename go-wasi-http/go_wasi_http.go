...
func WasiIo0_2_0_PollPoll(in []WasiIo0_2_0_PollPollable) []uint32 {
  ...
  var ret C.go_wasi_http_list_u32_t
...
func (self WasiIo0_2_0_StreamsInputStream) Read(len uint64) Result[[]uint8, WasiIo0_2_0_StreamsStreamError] {
  ...
  if ret.is_err {
    ...
    lift_ret_ptr := *(*C.go_wasi_http_list_u8_t)(unsafe.Pointer(&ret.val))
...
func (self WasiIo0_2_0_StreamsOutputStream) Write(contents []uint8) Result[struct{}, WasiIo0_2_0_StreamsStreamError] {
  var lower_self C.wasi_io_streams_borrow_output_stream_t
  lower_self.__handle = C.int32_t(self)
  var lower_contents C.go_wasi_http_list_u8_t
  if len(contents) == 0 {
...
func WasiHttp0_2_0_TypesHttpErrorCode(err WasiHttp0_2_0_TypesIoError) Option[WasiHttp0_2_0_TypesErrorCode] {
  ...
  if ret.is_some {
    ...
    if ret.val.tag == 17 {
      lift_ret_val_ptr := *(*C.go_wasi_http_option_u64_t)(unsafe.Pointer(&ret.val.val))
    ...
    if ret.val.tag == 21 {
      lift_ret_val_ptr := *(*C.go_wasi_http_option_u32_t)(unsafe.Pointer(&ret.val.val))
    ...
    if ret.val.tag == 31 {
      lift_ret_val_ptr := *(*C.go_wasi_http_option_string_t)(unsafe.Pointer(&ret.val.val))
...
func StaticFieldsFromList(entries []WasiHttp0_2_0_TypesTuple2FieldKeyFieldValueT) Result[WasiHttp0_2_0_TypesFields, WasiHttp0_2_0_TypesHeaderError] {
  var lower_entries C.go_wasi_http_list_tuple2_field_key_field_value_t
  if len(entries) == 0 {
    lower_entries.ptr = nil
    lower_entries.len = 0
  } else {
    var empty_lower_entries C.go_wasi_http_tuple2_field_key_field_value_t
    lower_entries.ptr = (*C.go_wasi_http_tuple2_field_key_field_value_t)(C.malloc(C.size_t(len(entries)) * C.size_t(unsafe.Sizeof(empty_lower_entries))))
    lower_entries.len = C.size_t(len(entries))
    for lower_entries_i := range entries {
      lower_entries_ptr := (*C.go_wasi_http_tuple2_field_key_field_value_t)(unsafe.Pointer(uintptr(unsafe.Pointer(lower_entries.ptr)) +
      uintptr(lower_entries_i)*unsafe.Sizeof(empty_lower_entries)))
      var lower_entries_ptr_value C.go_wasi_http_tuple2_field_key_field_value_t
      var lower_entries_ptr_value_f0 C.go_wasi_http_string_t
      var lower_entries_ptr_value_f0_val C.go_wasi_http_string_t
...
func (self WasiHttp0_2_0_TypesFields) Set(name WasiHttp0_2_0_TypesFieldKey, value [][]uint8) Result[struct{}, WasiHttp0_2_0_TypesHeaderError] {
  ...
  lower_name_val.len = C.size_t(len(name))
  lower_name = lower_name_val
  var lower_value C.go_wasi_http_list_field_value_t
  if len(value) == 0 {
    lower_value.ptr = nil
    lower_value.len = 0
  } else {
...
func (self WasiHttp0_2_0_TypesFields) Entries() []WasiHttp0_2_0_TypesTuple2FieldKeyFieldValueT {
  var lower_self C.wasi_http_types_borrow_fields_t
  lower_self.__handle = C.int32_t(self)
  var ret C.go_wasi_http_list_tuple2_field_key_field_value_t
  ...
  if ret.len > 0 {
    for lift_ret_i := 0; lift_ret_i < int(ret.len); lift_ret_i++ {
      var empty_lift_ret C.go_wasi_http_tuple2_field_key_field_value_t
      lift_ret_ptr := *(*C.go_wasi_http_tuple2_field_key_field_value_t)(unsafe.Pointer(uintptr(unsafe.Pointer(ret.ptr)) +
      uintptr(lift_ret_i)*unsafe.Sizeof(empty_lift_ret)))
...
func (self WasiHttp0_2_0_TypesIncomingRequest) PathWithQuery() Option[string] {
  var lower_self C.wasi_http_types_borrow_incoming_request_t
  lower_self.__handle = C.int32_t(self)
  var ret C.go_wasi_http_option_string_t
...
func (self WasiHttp0_2_0_TypesOutgoingRequest) SetPathWithQuery(path_with_query Option[string]) Result[struct{}, struct{}] {
  var lower_self C.wasi_http_types_borrow_outgoing_request_t
  lower_self.__handle = C.int32_t(self)
  var lower_path_with_query C.go_wasi_http_option_string_t
  if path_with_query.IsSome() {
    var lower_path_with_query_val C.go_wasi_http_string_t
...
func (self WasiHttp0_2_0_TypesOutgoingRequest) SetAuthority(authority Option[string]) Result[struct{}, struct{}] {
  var lower_self C.wasi_http_types_borrow_outgoing_request_t
  lower_self.__handle = C.int32_t(self)
  var lower_authority C.go_wasi_http_option_string_t
  if authority.IsSome() {
    var lower_authority_val C.go_wasi_http_string_t
...
func (self WasiHttp0_2_0_TypesRequestOptions) ConnectTimeout() Option[WasiHttp0_2_0_TypesDuration] {
  ...
  lower_self.__handle = C.int32_t(self)
  var ret C.go_wasi_http_option_duration_t
...
func (self WasiHttp0_2_0_TypesRequestOptions) SetConnectTimeout(duration Option[WasiHttp0_2_0_TypesDuration]) Result[struct{}, struct{}] {
  var lower_self C.wasi_http_types_borrow_request_options_t
  lower_self.__handle = C.int32_t(self)
  var lower_duration C.go_wasi_http_option_duration_t
  if duration.IsSome() {
  ...
  if response.IsOk() {
    ...
    *lower_response_ptr = lower_response_val
    ...
    if response.UnwrapErr().Kind() == WasiHttp0_2_0_TypesErrorCodeKindDnsError {
      ...
      var lower_response_val_val_rcode C.go_wasi_http_option_string_t
      if response.UnwrapErr().GetDnsError().Rcode.IsSome() {
        var lower_response_val_val_rcode_val C.go_wasi_http_string_t
      ...
      var lower_response_val_val_info_code C.go_wasi_http_option_u16_t
    ...
    if response.UnwrapErr().Kind() == WasiHttp0_2_0_TypesErrorCodeKindTlsAlertReceived {
      ...
      var lower_response_val_val_alert_id C.go_wasi_http_option_u8_t
      ...
      var lower_response_val_val_alert_message C.go_wasi_http_option_string_t
      if response.UnwrapErr().GetTlsAlertReceived().AlertMessage.IsSome() {
        var lower_response_val_val_alert_message_val C.go_wasi_http_string_t
    ...
    if response.UnwrapErr().Kind() == WasiHttp0_2_0_TypesErrorCodeKindHttpRequestBodySize {
      ...
      lower_response_val_ptr := (*C.go_wasi_http_option_u64_t)(unsafe.Pointer(&lower_response_val.val))
      var lower_response_val_val C.go_wasi_http_option_u64_t
    ...
    if response.UnwrapErr().Kind() == WasiHttp0_2_0_TypesErrorCodeKindHttpRequestHeaderSectionSize {
      ...
      lower_response_val_ptr := (*C.go_wasi_http_option_u32_t)(unsafe.Pointer(&lower_response_val.val))
      var lower_response_val_val C.go_wasi_http_option_u32_t
    ...
    if response.UnwrapErr().Kind() == WasiHttp0_2_0_TypesErrorCodeKindHttpRequestHeaderSize {
      ...
      if response.UnwrapErr().GetHttpRequestHeaderSize().IsSome() {
        ...
        var lower_response_val_val_val_field_name C.go_wasi_http_option_string_t
        if response.UnwrapErr().GetHttpRequestHeaderSize().Unwrap().FieldName.IsSome() {
          var lower_response_val_val_val_field_name_val C.go_wasi_http_string_t
        ...
        var lower_response_val_val_val_field_size C.go_wasi_http_option_u32_t
    ...
    if response.UnwrapErr().Kind() == WasiHttp0_2_0_TypesErrorCodeKindHttpRequestTrailerSize {
      ...
      var lower_response_val_val_field_name C.go_wasi_http_option_string_t
      if response.UnwrapErr().GetHttpRequestTrailerSize().FieldName.IsSome() {
        var lower_response_val_val_field_name_val C.go_wasi_http_string_t
      ...
      var lower_response_val_val_field_size C.go_wasi_http_option_u32_t
    ...
    if response.UnwrapErr().Kind() == WasiHttp0_2_0_TypesErrorCodeKindHttpResponseTransferCoding {
      ...
      lower_response_val_ptr := (*C.go_wasi_http_option_string_t)(unsafe.Pointer(&lower_response_val.val))
      var lower_response_val_val C.go_wasi_http_option_string_t
      if response.UnwrapErr().GetHttpResponseTransferCoding().IsSome() {
        var lower_response_val_val_val C.go_wasi_http_string_t
    ...
    if ret.val.is_err {
      ...
      if lift_ret_val_ptr.is_err {
        ...
        if lift_ret_val_val_ptr.tag == 17 {
          lift_ret_val_val_val_ptr := *(*C.go_wasi_http_option_u64_t)(unsafe.Pointer(&lift_ret_val_val_ptr.val))
        ...
        if lift_ret_val_val_ptr.tag == 21 {
          lift_ret_val_val_val_ptr := *(*C.go_wasi_http_option_u32_t)(unsafe.Pointer(&lift_ret_val_val_ptr.val))
        ...
        if lift_ret_val_val_ptr.tag == 31 {
          lift_ret_val_val_val_ptr := *(*C.go_wasi_http_option_string_t)(unsafe.Pointer(&lift_ret_val_val_ptr.val))
...
func StaticOutgoingBodyFinish(this WasiHttp0_2_0_TypesOutgoingBody, trailers Option[WasiHttp0_2_0_TypesTrailers]) Result[struct{}, WasiHttp0_2_0_TypesErrorCode] {
  ...
  if ret.is_err {
    ...
    if lift_ret_ptr.tag == 17 {
      lift_ret_val_ptr := *(*C.go_wasi_http_option_u64_t)(unsafe.Pointer(&lift_ret_ptr.val))
      var lift_ret_val_val Option[uint64]
      if lift_ret_val_ptr.is_some {
        var lift_ret_val_val_val uint64
        lift_ret_val_val_val = uint64(lift_ret_val_ptr.val)
    ...
    if lift_ret_ptr.tag == 21 {
      lift_ret_val_ptr := *(*C.go_wasi_http_option_u32_t)(unsafe.Pointer(&lift_ret_ptr.val))
      var lift_ret_val_val Option[uint32]
      if lift_ret_val_ptr.is_some {
        var lift_ret_val_val_val uint32
        lift_ret_val_val_val = uint32(lift_ret_val_ptr.val)
    ...
    if lift_ret_ptr.tag == 31 {
      lift_ret_val_ptr := *(*C.go_wasi_http_option_string_t)(unsafe.Pointer(&lift_ret_ptr.val))
      var lift_ret_val_val Option[string]
      if lift_ret_val_ptr.is_some {
        var lift_ret_val_val_val string
        lift_ret_val_val_val = C.GoStringN((*C.char)(unsafe.Pointer(lift_ret_val_ptr.val.ptr)), C.int(lift_ret_val_ptr.val.len))
...
func WasiHttp0_2_0_OutgoingHandlerHandle(request WasiHttp0_2_0_OutgoingHandlerOutgoingRequest, options Option[WasiHttp0_2_0_OutgoingHandlerRequestOptions]) Result[WasiHttp0_2_0_OutgoingHandlerFutureIncomingResponse, WasiHttp0_2_0_OutgoingHandlerErrorCode] {
  ...
  if ret.is_err {
    ...
    if lift_ret_ptr.tag == 17 {
      lift_ret_val_val_ptr := *(*C.go_wasi_http_option_u64_t)(unsafe.Pointer(&lift_ret_ptr.val))
    ...
    if lift_ret_ptr.tag == 21 {
      lift_ret_val_val_ptr := *(*C.go_wasi_http_option_u32_t)(unsafe.Pointer(&lift_ret_ptr.val))
    ...
    if lift_ret_ptr.tag == 31 {
      lift_ret_val_val_ptr := *(*C.go_wasi_http_option_string_t)(unsafe.Pointer(&lift_ret_ptr.val))
