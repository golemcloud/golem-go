...
#ifndef __BINDINGS_GOLEM_GO_BINDINGS_H
#define __BINDINGS_GOLEM_GO_BINDINGS_H
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct golem_go_bindings_string_t {
  uint8_t*ptr;
  size_t len;
} golem_go_bindings_string_t;
...
typedef struct {
  uint32_t *ptr;
  size_t len;
} golem_go_bindings_list_u32_t;

typedef int32_t golem_rpc_types_node_index_t;

typedef struct golem_rpc_types_uri_t {
  golem_go_bindings_string_t   value;
} golem_rpc_types_uri_t;

typedef struct {
  golem_rpc_types_node_index_t *ptr;
  size_t len;
} golem_go_bindings_list_node_index_t;

typedef struct {
  bool is_some;
  golem_rpc_types_node_index_t val;
} golem_go_bindings_option_node_index_t;

typedef struct {
  uint32_t f0;
  golem_go_bindings_option_node_index_t f1;
} golem_go_bindings_tuple2_u32_option_node_index_t;

typedef struct {
  bool *ptr;
  size_t len;
} golem_go_bindings_list_bool_t;

typedef struct {
  bool is_err;
  union {
    golem_go_bindings_option_node_index_t ok;
    golem_go_bindings_option_node_index_t err;
  } val;
...
typedef struct golem_rpc_types_wit_node_t {
  uint8_t tag;
  union {
    golem_go_bindings_list_node_index_t     record_value;
    golem_go_bindings_tuple2_u32_option_node_index_t     variant_value;
    uint32_t     enum_value;
    golem_go_bindings_list_bool_t     flags_value;
    golem_go_bindings_list_node_index_t     tuple_value;
    golem_go_bindings_list_node_index_t     list_value;
    golem_go_bindings_option_node_index_t     option_value;
    ...
    uint32_t     prim_char;
    bool     prim_bool;
    golem_go_bindings_string_t     prim_string;
...
typedef struct golem_rpc_types_rpc_error_t {
  uint8_t tag;
  union {
    golem_go_bindings_string_t     protocol_error;
    golem_go_bindings_string_t     denied;
    golem_go_bindings_string_t     not_found;
    golem_go_bindings_string_t     remote_internal_error;
  } val;
...
typedef struct golem_api_host_worker_id_t {
  ...
  golem_go_bindings_string_t   worker_name;
...
typedef struct golem_api_host_worker_env_filter_t {
  golem_go_bindings_string_t   name;
  golem_api_host_string_filter_comparator_t   comparator;
  golem_go_bindings_string_t   value;
...
typedef struct {
  golem_go_bindings_string_t *ptr;
  size_t len;
} golem_go_bindings_list_string_t;

typedef struct {
  golem_go_bindings_string_t f0;
  golem_go_bindings_string_t f1;
} golem_go_bindings_tuple2_string_string_t;

typedef struct {
  golem_go_bindings_tuple2_string_string_t *ptr;
  size_t len;
} golem_go_bindings_list_tuple2_string_string_t;

typedef struct golem_api_host_worker_metadata_t {
  golem_api_host_worker_id_t   worker_id;
  golem_go_bindings_list_string_t   args;
  golem_go_bindings_list_tuple2_string_string_t   env;
...
typedef struct {
  bool is_err;
  union {
    golem_go_bindings_list_u8_t ok;
...
typedef golem_go_bindings_string_t wasi_blobstore_types_container_name_t;

// name of an object within a container
// The object name may be any valid UTF-8 string.
typedef golem_go_bindings_string_t wasi_blobstore_types_object_name_t;
...
typedef golem_go_bindings_string_t wasi_blobstore_types_error_t;
...
typedef struct {
  ...
  size_t len;
} golem_go_bindings_list_object_name_t;
...
typedef struct {
  golem_go_bindings_list_object_name_t f0;
  bool f1;
} golem_go_bindings_tuple2_list_object_name_bool_t;

typedef struct {
  bool is_err;
  union {
    golem_go_bindings_tuple2_list_object_name_bool_t ok;
    wasi_blobstore_container_error_t err;
  } val;
...
typedef struct {
  uint64_t f0;
  bool f1;
} golem_go_bindings_tuple2_u64_bool_t;

typedef struct {
  bool is_err;
  union {
    golem_go_bindings_tuple2_u64_bool_t ok;
    wasi_blobstore_container_error_t err;
  } val;
...
typedef struct {
  golem_go_bindings_list_u8_t f0;
  bool f1;
} golem_go_bindings_tuple2_list_u8_bool_t;

typedef struct {
  bool is_err;
  union {
    golem_go_bindings_tuple2_list_u8_bool_t ok;
    wasi_filesystem_types_error_code_t err;
  } val;
...
typedef struct wasi_http_types_method_t {
  uint8_t tag;
  union {
    golem_go_bindings_string_t     other;
  } val;
...
typedef struct wasi_http_types_dns_error_payload_t {
  golem_go_bindings_option_string_t   rcode;
  golem_go_bindings_option_u16_t   info_code;
} wasi_http_types_dns_error_payload_t;

typedef struct {
  bool is_some;
  uint8_t val;
} golem_go_bindings_option_u8_t;

// Defines the case payload type for `TLS-alert-received` above:
typedef struct wasi_http_types_tls_alert_received_payload_t {
  golem_go_bindings_option_u8_t   alert_id;
  golem_go_bindings_option_string_t   alert_message;
} wasi_http_types_tls_alert_received_payload_t;

typedef struct {
  bool is_some;
  uint32_t val;
} golem_go_bindings_option_u32_t;

// Defines the case payload type for `HTTP-response-{header,trailer}-size` above:
typedef struct wasi_http_types_field_size_payload_t {
  golem_go_bindings_option_string_t   field_name;
  golem_go_bindings_option_u32_t   field_size;
} wasi_http_types_field_size_payload_t;

typedef struct {
  bool is_some;
  uint64_t val;
} golem_go_bindings_option_u64_t;
...
typedef struct wasi_http_types_error_code_t {
  ...
  union {
    ...
    golem_go_bindings_option_u64_t     http_request_body_size;
    golem_go_bindings_option_u32_t     http_request_header_section_size;
    wasi_http_types_option_field_size_payload_t     http_request_header_size;
    golem_go_bindings_option_u32_t     http_request_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_request_trailer_size;
    golem_go_bindings_option_u32_t     http_response_header_section_size;
    wasi_http_types_field_size_payload_t     http_response_header_size;
    golem_go_bindings_option_u64_t     http_response_body_size;
    golem_go_bindings_option_u32_t     http_response_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_response_trailer_size;
    golem_go_bindings_option_string_t     http_response_transfer_coding;
    golem_go_bindings_option_string_t     http_response_content_coding;
    golem_go_bindings_option_string_t     internal_error;
  } val;
...
typedef golem_go_bindings_string_t wasi_http_types_field_key_t;
...
} golem_go_bindings_tuple2_field_key_field_value_t;

typedef struct {
  golem_go_bindings_tuple2_field_key_field_value_t *ptr;
  size_t len;
} golem_go_bindings_list_tuple2_field_key_field_value_t;
...
typedef struct {
  ...
  size_t len;
} golem_go_bindings_list_field_value_t;
...
} golem_go_bindings_option_duration_t;
...
typedef struct wasi_keyvalue_wasi_keyvalue_error_own_error_t {
  int32_t __handle;
} wasi_keyvalue_wasi_keyvalue_error_own_error_t;

typedef struct wasi_keyvalue_wasi_keyvalue_error_borrow_error_t {
  int32_t __handle;
} wasi_keyvalue_wasi_keyvalue_error_borrow_error_t;

typedef struct wasi_keyvalue_types_own_bucket_t {
  int32_t __handle;
} wasi_keyvalue_types_own_bucket_t;

typedef struct wasi_keyvalue_types_borrow_bucket_t {
  int32_t __handle;
} wasi_keyvalue_types_borrow_bucket_t;

// A key is a unique identifier for a value in a bucket. The key is used to
// retrieve the value from the bucket.
typedef golem_go_bindings_string_t wasi_keyvalue_types_key_t;

typedef struct wasi_keyvalue_types_own_outgoing_value_t {
  int32_t __handle;
} wasi_keyvalue_types_own_outgoing_value_t;

typedef struct wasi_keyvalue_types_borrow_outgoing_value_t {
  int32_t __handle;
} wasi_keyvalue_types_borrow_outgoing_value_t;

typedef struct wasi_keyvalue_types_outgoing_value_body_sync_t {
  uint8_t   *ptr;
  size_t len;
} wasi_keyvalue_types_outgoing_value_body_sync_t;

typedef struct wasi_keyvalue_types_own_incoming_value_t {
  int32_t __handle;
} wasi_keyvalue_types_own_incoming_value_t;

typedef struct wasi_keyvalue_types_borrow_incoming_value_t {
  int32_t __handle;
} wasi_keyvalue_types_borrow_incoming_value_t;

typedef struct wasi_keyvalue_types_incoming_value_sync_body_t {
  uint8_t   *ptr;
  size_t len;
} wasi_keyvalue_types_incoming_value_sync_body_t;

typedef wasi_keyvalue_wasi_keyvalue_error_own_error_t wasi_keyvalue_types_own_error_t;

typedef struct {
  bool is_err;
  union {
    wasi_keyvalue_types_own_bucket_t ok;
    wasi_keyvalue_types_own_error_t err;
  } val;
} wasi_keyvalue_types_result_own_bucket_own_error_t;

typedef wasi_io_streams_own_output_stream_t wasi_keyvalue_types_own_outgoing_value_body_async_t;

typedef struct {
  bool is_err;
  union {
    wasi_keyvalue_types_own_outgoing_value_body_async_t ok;
    wasi_keyvalue_types_own_error_t err;
  } val;
} wasi_keyvalue_types_result_own_outgoing_value_body_async_own_error_t;
...
} wasi_keyvalue_types_result_void_own_error_t;
...
} wasi_keyvalue_types_result_incoming_value_sync_body_own_error_t;

typedef wasi_io_streams_own_input_stream_t wasi_keyvalue_types_own_incoming_value_async_body_t;

typedef struct {
  bool is_err;
  union {
    wasi_keyvalue_types_own_incoming_value_async_body_t ok;
    wasi_keyvalue_types_own_error_t err;
  } val;
} wasi_keyvalue_types_result_own_incoming_value_async_body_own_error_t;
...
} wasi_keyvalue_types_result_u64_own_error_t;

typedef wasi_keyvalue_types_key_t wasi_keyvalue_eventual_batch_key_t;

typedef wasi_keyvalue_types_borrow_bucket_t wasi_keyvalue_eventual_batch_borrow_bucket_t;

typedef struct {
  wasi_keyvalue_eventual_batch_key_t *ptr;
  size_t len;
} golem_go_bindings_list_key_t;

typedef wasi_keyvalue_types_own_incoming_value_t wasi_keyvalue_eventual_batch_own_incoming_value_t;

typedef struct {
  bool is_some;
  wasi_keyvalue_eventual_batch_own_incoming_value_t val;
} wasi_keyvalue_eventual_batch_option_own_incoming_value_t;

typedef struct {
  wasi_keyvalue_eventual_batch_option_own_incoming_value_t *ptr;
  size_t len;
} wasi_keyvalue_eventual_batch_list_option_own_incoming_value_t;

typedef wasi_keyvalue_wasi_keyvalue_error_own_error_t wasi_keyvalue_eventual_batch_own_error_t;

typedef struct {
  bool is_err;
  union {
    wasi_keyvalue_eventual_batch_list_option_own_incoming_value_t ok;
    wasi_keyvalue_eventual_batch_own_error_t err;
  } val;
} wasi_keyvalue_eventual_batch_result_list_option_own_incoming_value_own_error_t;

typedef struct {
  bool is_err;
  union {
    golem_go_bindings_list_key_t ok;
    wasi_keyvalue_eventual_batch_own_error_t err;
  } val;
} wasi_keyvalue_eventual_batch_result_list_key_own_error_t;

typedef wasi_keyvalue_types_borrow_outgoing_value_t wasi_keyvalue_eventual_batch_borrow_outgoing_value_t;

typedef struct {
  wasi_keyvalue_eventual_batch_key_t f0;
  wasi_keyvalue_eventual_batch_borrow_outgoing_value_t f1;
} wasi_keyvalue_eventual_batch_tuple2_key_borrow_outgoing_value_t;

typedef struct {
  wasi_keyvalue_eventual_batch_tuple2_key_borrow_outgoing_value_t *ptr;
  size_t len;
} wasi_keyvalue_eventual_batch_list_tuple2_key_borrow_outgoing_value_t;
...
} wasi_keyvalue_eventual_batch_result_void_own_error_t;

typedef wasi_keyvalue_types_key_t wasi_keyvalue_eventual_key_t;

typedef wasi_keyvalue_types_borrow_bucket_t wasi_keyvalue_eventual_borrow_bucket_t;

typedef wasi_keyvalue_types_own_incoming_value_t wasi_keyvalue_eventual_own_incoming_value_t;

typedef struct {
  bool is_some;
  wasi_keyvalue_eventual_own_incoming_value_t val;
} wasi_keyvalue_eventual_option_own_incoming_value_t;

typedef wasi_keyvalue_wasi_keyvalue_error_own_error_t wasi_keyvalue_eventual_own_error_t;

typedef struct {
  bool is_err;
  union {
    wasi_keyvalue_eventual_option_own_incoming_value_t ok;
    wasi_keyvalue_eventual_own_error_t err;
  } val;
} wasi_keyvalue_eventual_result_option_own_incoming_value_own_error_t;

typedef wasi_keyvalue_types_borrow_outgoing_value_t wasi_keyvalue_eventual_borrow_outgoing_value_t;
...
} wasi_keyvalue_eventual_result_void_own_error_t;
...
} wasi_keyvalue_eventual_result_bool_own_error_t;
...
extern void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, golem_go_bindings_list_u32_t *ret);
...
extern void golem_rpc_types_method_wasm_rpc_invoke_and_await(golem_rpc_types_borrow_wasm_rpc_t self, golem_go_bindings_string_t *function_name, golem_rpc_types_list_wit_value_t *function_params, golem_rpc_types_result_wit_value_rpc_error_t *ret);
extern void golem_rpc_types_method_wasm_rpc_invoke(golem_rpc_types_borrow_wasm_rpc_t self, golem_go_bindings_string_t *function_name, golem_rpc_types_list_wit_value_t *function_params, golem_rpc_types_result_void_rpc_error_t *ret);
extern golem_rpc_types_own_future_invoke_result_t golem_rpc_types_method_wasm_rpc_async_invoke_and_await(golem_rpc_types_borrow_wasm_rpc_t self, golem_go_bindings_string_t *function_name, golem_rpc_types_list_wit_value_t *function_params);
...
extern void golem_api_host_golem_create_promise(golem_api_host_promise_id_t *ret);
// Suspends execution until the given promise gets completed, and returns the payload passed to
// the promise completion.
extern void golem_api_host_golem_await_promise(golem_api_host_promise_id_t *promise_id, golem_go_bindings_list_u8_t *ret);
...
extern bool golem_api_host_golem_complete_promise(golem_api_host_promise_id_t *promise_id, golem_go_bindings_list_u8_t *data);
// Deletes the given promise
extern void golem_api_host_golem_delete_promise(golem_api_host_promise_id_t *promise_id);
// Returns a Golem worker URI that can be used to invoke a given function on the current worker
extern void golem_api_host_get_self_uri(golem_go_bindings_string_t *function_name, golem_api_host_uri_t *ret);
...
// hazard.
extern void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, golem_go_bindings_string_t *ret);
...
extern void wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, golem_go_bindings_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret);
...
// ```
extern void wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, golem_go_bindings_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret);
...
extern void wasi_blobstore_container_method_container_delete_objects(wasi_blobstore_container_borrow_container_t self, golem_go_bindings_list_object_name_t *names, wasi_blobstore_container_result_void_error_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_write(wasi_filesystem_types_borrow_descriptor_t self, golem_go_bindings_list_u8_t *buffer, wasi_filesystem_types_filesize_t offset, wasi_filesystem_types_result_filesize_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_create_directory_at(wasi_filesystem_types_borrow_descriptor_t self, golem_go_bindings_string_t *path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_stat_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, golem_go_bindings_string_t *path, wasi_filesystem_types_result_descriptor_stat_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_link_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t old_path_flags, golem_go_bindings_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, golem_go_bindings_string_t *new_path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_open_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, golem_go_bindings_string_t *path, wasi_filesystem_types_open_flags_t open_flags, wasi_filesystem_types_descriptor_flags_t flags, wasi_filesystem_types_result_own_descriptor_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_readlink_at(wasi_filesystem_types_borrow_descriptor_t self, golem_go_bindings_string_t *path, wasi_filesystem_types_result_string_error_code_t *ret);
// Remove a directory.
// 
// Return `error-code::not-empty` if the directory is not empty.
// 
// Note: This is similar to `unlinkat(fd, path, AT_REMOVEDIR)` in POSIX.
extern void wasi_filesystem_types_method_descriptor_remove_directory_at(wasi_filesystem_types_borrow_descriptor_t self, golem_go_bindings_string_t *path, wasi_filesystem_types_result_void_error_code_t *ret);
// Rename a filesystem object.
// 
// Note: This is similar to `renameat` in POSIX.
extern void wasi_filesystem_types_method_descriptor_rename_at(wasi_filesystem_types_borrow_descriptor_t self, golem_go_bindings_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, golem_go_bindings_string_t *new_path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_symlink_at(wasi_filesystem_types_borrow_descriptor_t self, golem_go_bindings_string_t *old_path, golem_go_bindings_string_t *new_path, wasi_filesystem_types_result_void_error_code_t *ret);
// Unlink a filesystem object that is not a directory.
// 
// Return `error-code::is-directory` if the path refers to a directory.
// Note: This is similar to `unlinkat(fd, path, 0)` in POSIX.
extern void wasi_filesystem_types_method_descriptor_unlink_file_at(wasi_filesystem_types_borrow_descriptor_t self, golem_go_bindings_string_t *path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_metadata_hash_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, golem_go_bindings_string_t *path, wasi_filesystem_types_result_metadata_hash_value_error_code_t *ret);
...
extern void wasi_http_types_static_fields_from_list(golem_go_bindings_list_tuple2_field_key_field_value_t *entries, wasi_http_types_result_own_fields_header_error_t *ret);
// Get all of the values corresponding to a key. If the key is not present
// in this `fields`, an empty list is returned. However, if the key is
// present but empty, this is represented by a list with one or more
// empty field-values present.
extern void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_key_t *name, golem_go_bindings_list_field_value_t *ret);
...
extern void wasi_http_types_method_fields_set(wasi_http_types_borrow_fields_t self, wasi_http_types_field_key_t *name, golem_go_bindings_list_field_value_t *value, wasi_http_types_result_void_header_error_t *ret);
...
// which have multiple values are represented by multiple entries in this
// list with the same key.
extern void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, golem_go_bindings_list_tuple2_field_key_field_value_t *ret);
...
extern void wasi_http_types_method_incoming_request_path_with_query(wasi_http_types_borrow_incoming_request_t self, golem_go_bindings_option_string_t *ret);
...
extern void wasi_http_types_method_incoming_request_authority(wasi_http_types_borrow_incoming_request_t self, golem_go_bindings_option_string_t *ret);
...
extern void wasi_http_types_method_outgoing_request_path_with_query(wasi_http_types_borrow_outgoing_request_t self, golem_go_bindings_option_string_t *ret);
// Set the combination of the HTTP Path and Query for the Request.
// When `none`, this represents an empty Path and empty Query. Fails is the
// string given is not a syntactically valid path and query uri component.
extern void wasi_http_types_method_outgoing_request_set_path_with_query(wasi_http_types_borrow_outgoing_request_t self, golem_go_bindings_option_string_t *path_with_query, wasi_http_types_result_void_void_t *ret);
...
extern void wasi_http_types_method_outgoing_request_authority(wasi_http_types_borrow_outgoing_request_t self, golem_go_bindings_option_string_t *ret);
// Set the HTTP Authority for the Request. A value of `none` may be used
// with Related Schemes which do not require an Authority. The HTTP and
// HTTPS schemes always require an authority. Fails if the string given is
// not a syntactically valid uri authority.
extern void wasi_http_types_method_outgoing_request_set_authority(wasi_http_types_borrow_outgoing_request_t self, golem_go_bindings_option_string_t *authority, wasi_http_types_result_void_void_t *ret);
// Get the headers associated with the Request.
// 
// The returned `headers` resource is immutable: `set`, `append`, and
// `delete` operations will fail with `header-error.immutable`.
...
extern void wasi_http_types_method_request_options_connect_timeout(wasi_http_types_borrow_request_options_t self, golem_go_bindings_option_duration_t *ret);
// Set the timeout for the initial connect to the HTTP Server. An error
// return value indicates that this timeout is not supported.
extern void wasi_http_types_method_request_options_set_connect_timeout(wasi_http_types_borrow_request_options_t self, golem_go_bindings_option_duration_t *duration, wasi_http_types_result_void_void_t *ret);
// The timeout for receiving the first byte of the Response body.
extern void wasi_http_types_method_request_options_first_byte_timeout(wasi_http_types_borrow_request_options_t self, golem_go_bindings_option_duration_t *ret);
// Set the timeout for receiving the first byte of the Response body. An
// error return value indicates that this timeout is not supported.
extern void wasi_http_types_method_request_options_set_first_byte_timeout(wasi_http_types_borrow_request_options_t self, golem_go_bindings_option_duration_t *duration, wasi_http_types_result_void_void_t *ret);
// The timeout for receiving subsequent chunks of bytes in the Response
// body stream.
extern void wasi_http_types_method_request_options_between_bytes_timeout(wasi_http_types_borrow_request_options_t self, golem_go_bindings_option_duration_t *ret);
// Set the timeout for receiving subsequent chunks of bytes in the Response
// body stream. An error return value indicates that this timeout is not
// supported.
extern void wasi_http_types_method_request_options_set_between_bytes_timeout(wasi_http_types_borrow_request_options_t self, golem_go_bindings_option_duration_t *duration, wasi_http_types_result_void_void_t *ret);
...
extern void wasi_keyvalue_wasi_keyvalue_error_method_error_trace(wasi_keyvalue_wasi_keyvalue_error_borrow_error_t self, golem_go_bindings_string_t *ret);
...
extern void wasi_keyvalue_types_static_bucket_open_bucket(golem_go_bindings_string_t *name, wasi_keyvalue_types_result_own_bucket_own_error_t *ret);
extern wasi_keyvalue_types_own_outgoing_value_t wasi_keyvalue_types_static_outgoing_value_new_outgoing_value(void);
// Writes the value to the output-stream asynchronously.
// If any other error occurs, it returns an `Err(error)`.
extern void wasi_keyvalue_types_method_outgoing_value_outgoing_value_write_body_async(wasi_keyvalue_types_borrow_outgoing_value_t self, wasi_keyvalue_types_result_own_outgoing_value_body_async_own_error_t *ret);
// Writes the value to the output-stream synchronously.
// If any other error occurs, it returns an `Err(error)`.
extern void wasi_keyvalue_types_method_outgoing_value_outgoing_value_write_body_sync(wasi_keyvalue_types_borrow_outgoing_value_t self, wasi_keyvalue_types_outgoing_value_body_sync_t *value, wasi_keyvalue_types_result_void_own_error_t *ret);
// Consumes the value synchronously and returns the value as a list of bytes.
// If any other error occurs, it returns an `Err(error)`.
extern void wasi_keyvalue_types_method_incoming_value_incoming_value_consume_sync(wasi_keyvalue_types_borrow_incoming_value_t self, wasi_keyvalue_types_result_incoming_value_sync_body_own_error_t *ret);
// Consumes the value asynchronously and returns the value as an `input-stream`.
// If any other error occurs, it returns an `Err(error)`.
extern void wasi_keyvalue_types_method_incoming_value_incoming_value_consume_async(wasi_keyvalue_types_borrow_incoming_value_t self, wasi_keyvalue_types_result_own_incoming_value_async_body_own_error_t *ret);
// The size of the value in bytes.
// If the size is unknown or unavailable, this function returns an `Err(error)`.
extern void wasi_keyvalue_types_method_incoming_value_incoming_value_size(wasi_keyvalue_types_borrow_incoming_value_t self, wasi_keyvalue_types_result_u64_own_error_t *ret);
...
// 
// If any other error occurs, it returns an `Err(error)`.
extern void wasi_keyvalue_eventual_batch_get_many(wasi_keyvalue_eventual_batch_borrow_bucket_t bucket, golem_go_bindings_list_key_t *keys, wasi_keyvalue_eventual_batch_result_list_option_own_incoming_value_own_error_t *ret);
...
extern void wasi_keyvalue_eventual_batch_keys(wasi_keyvalue_eventual_batch_borrow_bucket_t bucket, wasi_keyvalue_eventual_batch_result_list_key_own_error_t *ret);
...
extern void wasi_keyvalue_eventual_batch_set_many(wasi_keyvalue_eventual_batch_borrow_bucket_t bucket, wasi_keyvalue_eventual_batch_list_tuple2_key_borrow_outgoing_value_t *key_values, wasi_keyvalue_eventual_batch_result_void_own_error_t *ret);
...
// 
// Other concurrent operations may also be able to see the partial results.
extern void wasi_keyvalue_eventual_batch_delete_many(wasi_keyvalue_eventual_batch_borrow_bucket_t bucket, golem_go_bindings_list_key_t *keys, wasi_keyvalue_eventual_batch_result_void_own_error_t *ret);
...
// 
// If any other error occurs, it returns an `Err(error)`.
extern void wasi_keyvalue_eventual_get(wasi_keyvalue_eventual_borrow_bucket_t bucket, wasi_keyvalue_eventual_key_t *key, wasi_keyvalue_eventual_result_option_own_incoming_value_own_error_t *ret);
...
// 
// If any other error occurs, it returns an `Err(error)`.
extern void wasi_keyvalue_eventual_set(wasi_keyvalue_eventual_borrow_bucket_t bucket, wasi_keyvalue_eventual_key_t *key, wasi_keyvalue_eventual_borrow_outgoing_value_t outgoing_value, wasi_keyvalue_eventual_result_void_own_error_t *ret);
// Delete the key-value pair associated with the key in the bucket.
// 
// If the key does not exist in the bucket, it does nothing.
// 
// If any other error occurs, it returns an `Err(error)`.
extern void wasi_keyvalue_eventual_delete(wasi_keyvalue_eventual_borrow_bucket_t bucket, wasi_keyvalue_eventual_key_t *key, wasi_keyvalue_eventual_result_void_own_error_t *ret);
...
// 
// If any other error occurs, it returns an `Err(error)`.
extern void wasi_keyvalue_eventual_exists(wasi_keyvalue_eventual_borrow_bucket_t bucket, wasi_keyvalue_eventual_key_t *key, wasi_keyvalue_eventual_result_bool_own_error_t *ret);
...
extern void wasi_sockets_ip_name_lookup_resolve_addresses(wasi_sockets_ip_name_lookup_borrow_network_t network, golem_go_bindings_string_t *name, wasi_sockets_ip_name_lookup_result_own_resolve_address_stream_error_code_t *ret);
...
extern void wasi_keyvalue_wasi_keyvalue_error_error_drop_own(wasi_keyvalue_wasi_keyvalue_error_own_error_t handle);

extern wasi_keyvalue_wasi_keyvalue_error_borrow_error_t wasi_keyvalue_wasi_keyvalue_error_borrow_error(wasi_keyvalue_wasi_keyvalue_error_own_error_t handle);

extern void wasi_keyvalue_types_bucket_drop_own(wasi_keyvalue_types_own_bucket_t handle);

extern wasi_keyvalue_types_borrow_bucket_t wasi_keyvalue_types_borrow_bucket(wasi_keyvalue_types_own_bucket_t handle);

void wasi_keyvalue_types_key_free(wasi_keyvalue_types_key_t *ptr);

extern void wasi_keyvalue_types_outgoing_value_drop_own(wasi_keyvalue_types_own_outgoing_value_t handle);

extern wasi_keyvalue_types_borrow_outgoing_value_t wasi_keyvalue_types_borrow_outgoing_value(wasi_keyvalue_types_own_outgoing_value_t handle);

void wasi_keyvalue_types_outgoing_value_body_sync_free(wasi_keyvalue_types_outgoing_value_body_sync_t *ptr);

extern void wasi_keyvalue_types_incoming_value_drop_own(wasi_keyvalue_types_own_incoming_value_t handle);

extern wasi_keyvalue_types_borrow_incoming_value_t wasi_keyvalue_types_borrow_incoming_value(wasi_keyvalue_types_own_incoming_value_t handle);
